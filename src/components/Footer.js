...
export default function Footer() {
  return (
    <footer className="bg-[#040912] border-t border-slate-800 text-slate-400 pt-14 pb-8 mt-auto">
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          {/* Brand */}
          <div className="md:col-span-1 flex flex-col gap-4">
            <Image src="/userbyte-logo.svg" alt="UserByte Solution" width={150} height={38} />
            <p className="text-sm text-slate-500 leading-relaxed">
              Delivering innovative software solutions that empower businesses to grow and succeed in the digital era.
            </p>
            {/* Social */}
            <div className="flex gap-3 mt-1">
              {[
                { label: "LinkedIn", href: "https://www.linkedin.com/company/userbyte-solutions/", icon: <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" /> },
                { label: "Facebook", href: "https://www.facebook.com/profile.php?id=61578604492669", icon: <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" /> },
              ].map((s) => (
                <a key={s.label} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.label}
                  className="w-8 h-8 rounded-lg bg-slate-800 hover:bg-cyan-500/20 hover:text-cyan-400 flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm">
              ...
              <li><Link href="/research" className="hover:text-cyan-400 transition-colors">R&amp;D</Link></li>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-sm">
              ...
              <li><Link href="/#services" className="hover:text-cyan-400 transition-colors">Cloud Solutions</Link></li>
              <li><Link href="/#services" className="hover:text-cyan-400 transition-colors">AI &amp; Automation</Link></li>
              <li><Link href="/#services" className="hover:text-cyan-400 transition-colors">Cybersecurity</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 text-sm text-slate-500">
              <li className="flex items-start gap-2"><span>📧</span> info.userbyte@gmail.comema</li>
